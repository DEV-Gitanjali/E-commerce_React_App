...
const Details = () => {
  return (
    ...
    <img className= ' object-contain h-[80%] w-[45%] ' src="https://fakestoreapi.com/img/81fPKd-2AYL._AC_SL1500_.jpg" alt="" />
    ...
    <div className='content  w-[45%]'>
        ...
        <Link className='py-2 px-5 mr-3 border rounded border-blue-200  text-blue-300'>Edit</Link>
        <Link className='py-2 px-5 border rounded border-blue-200  text-red-300'>Delete</Link>
    </div>
